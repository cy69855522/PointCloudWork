...
from .utils.pointnet2_modules import PointnetSAModule, PointnetFPModule, PointnetSAModuleMSG
...
class Net(nn.Module):
    ...
    def forward(self, data):
        ...
        N = int(len(data.pos) / B)
        cls = nn.functional.one_hot(data.y, 16)
        pointcloud = data.pos.view(B, N, -1)
