...
from module.point_mlp.point_mlp import PointNetFeaturePropagation, ConvBNReLU1D, LocalGrouper, PreExtraction, PosExtraction, get_activation
...
class Net(nn.Module):
    ...
    def forward(self, data):
        ...
        x = pos.view(B, N, -1).transpose(1, 2).contiguous()
        norm_plt = norm.view(B, N, -1).transpose(1, 2).contiguous()
        cls_label = F.one_hot(data.y, 16).float()
